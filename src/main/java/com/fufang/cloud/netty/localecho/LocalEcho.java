 ...
 * under the License.
 */
package com.fufang.cloud.netty.localecho;
...
public final class LocalEcho {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            // Note that we can use any event loop to ensure certain local channelGroup
            // are handled by the same event loop thread which drives a certain socket channel
            // to reduce the communication latency between socket channelGroup and local channelGroup.
